...
object SetBattleMonsterAppearancePacketCodec : PacketCodec<SetBattleMonsterAppearancePacket>() {
  override fun CodecScope<SetBattleMonsterAppearancePacket>.body():
    ...
    return SetBattleMonsterAppearancePacket(partySlot, pokemonEntityId, shininessType, colorPalette)
  }
}
