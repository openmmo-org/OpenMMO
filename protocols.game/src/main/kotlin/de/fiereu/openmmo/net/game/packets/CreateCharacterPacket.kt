...
/** C2S 0x03 create-character request. v31914 sends name + gender + trailing cosmetics bytes. */
data class CreateCharacterPacket(
    val name: String,
    val gender: Byte,
    val cosmetics: ByteArray,
) {
  override fun equals(other: Any?): Boolean =
      other is CreateCharacterPacket &&
          name == other.name &&
          gender == other.gender &&
          cosmetics.contentEquals(other.cosmetics)
...
private object RemainingBytesCodec : Codec<ByteArray> {
