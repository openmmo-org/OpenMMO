...
data class FieldMapBattleSlotTileMapPacket(
    val groupId: Short,
    val slotTiles: List<BattleSlotTile>?,
)

object FieldMapBattleSlotTileMapPacketCodec : PacketCodec<FieldMapBattleSlotTileMapPacket>() {
  override fun CodecScope<FieldMapBattleSlotTileMapPacket>.body(): FieldMapBattleSlotTileMapPacket {
    ...
    return FieldMapBattleSlotTileMapPacket(groupId, slotTiles)
  }
}
